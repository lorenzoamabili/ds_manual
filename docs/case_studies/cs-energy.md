...
- **Transfer challenge**: a cooling policy trained on one data centre doesn't transfer directly to another — each has different thermal characteristics, equipment, and workload patterns. They [fine-tuned](11-computer-vision.md) per-facility rather than applying a single global policy.
...
## Ørsted — offshore wind farm power [forecasting](07-time-series-forecasting.md)
